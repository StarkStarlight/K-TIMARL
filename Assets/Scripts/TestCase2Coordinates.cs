...
public class TestCase2Coordinates : MonoBehaviour
{
    ...
    public static readonly Dictionary<string, BLcoordinate[]> BuyoCoordinates = new Dictionary<string, BLcoordinate[]> {
        {"buyo_Green", new BLcoordinate[] { new BLcoordinate(-600, -100), new BLcoordinate(0, -100), new BLcoordinate(300, -400), 
                                            new BLcoordinate(600, -700), new BLcoordinate(400, 300), new BLcoordinate(700, 600), new BLcoordinate(250, 50) }
        },
        {"buyo_Red", new BLcoordinate[]   { new BLcoordinate(-600, 100), new BLcoordinate(0, 100), new BLcoordinate(300, 400),
                                            new BLcoordinate(600, 700), new BLcoordinate(400, -300), new BLcoordinate(700, -600), new BLcoordinate(250, -50) }
        }
    };
